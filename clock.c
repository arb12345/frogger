 ...
 * them as reference to set MCLK @25Hz, SMCLK @25MHz and
 * ACLK @32768Hz.
 */
...
//            XTS             |             // XT1 low-frequency mode, which
    ...
    UCSCTL1 = DCORSEL_7       |             // Select DCO range to around 25MHz
//            DISMOD          |             // Enable modulator
              0;

    UCSCTL2 = FLLD_0          |             // Set FLL dividers
              762;                      	// DCOCLK = 1 * (762+1) * FLLREF

    UCSCTL3 = SELREF__XT1CLK |              // Use XT1 Oscillator for FLLREF
              FLLREFDIV__1;                 // divided by 1

    UCSCTL5 = DIVPA__1        |             // Output dividers to 1
               DIVA__1        |             // ACLK  divided by 1
               DIVS__1        |             // SMCLK divided by 1
    ...
    UCSCTL4 = SELA__XT1CLK    |             // ACLK  = XT1   =>      32.768 Hz
              SELS__DCOCLK    |             // SMCLK = DCO   =>  25.000.000 Hz
